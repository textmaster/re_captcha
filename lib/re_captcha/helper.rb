module ReCaptcha
  module Helper
    ...
    def recaptcha_tags(options = {})
      html = ''
      html << %{<div class="g-recaptcha" data-sitekey="#{ReCaptcha.client.public_key}" data-stoken="#{ReCaptcha.client.secure_token}" #{tag_attributes(options)}></div>\n}
    ...
    def tag_attributes(theme: 'light', type: 'image', size: 'normal', tab_index: 0, callback: nil, expired_callback: nil)
      attributes = ''
